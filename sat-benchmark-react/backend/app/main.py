...
from app.api import solvers, benchmarks, experiments, analysis, dashboard, sat_modeler, rigorous_analysis, tuning
...
app.include_router(tuning.router, prefix="/api/tuning", tags=["Algorithm Configuration"])
