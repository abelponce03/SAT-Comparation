...
- [📋 Informe Técnico: SAT Benchmark Suite v2.0](#-informe-técnico-sat-benchmark-suite-v20)
  - [Plataforma Integral para Benchmarking y Análisis Estadístico Riguroso de Solvers SAT](#plataforma-integral-para-benchmarking-y-análisis-estadístico-riguroso-de-solvers-sat)
  ...
  - [3. Arquitectura del Sistema](#3-arquitectura-del-sistema)
    ...
    - [3.2 Flujo de Datos](#32-flujo-de-datos)
  - [4. Módulos de la Aplicación](#4-módulos-de-la-aplicación)
    ...
    - [4.5 Analysis](#45-analysis)
      - [Ejemplos del Módulo de Análisis](#ejemplos-del-módulo-de-análisis)
  ...
  - [5. Pipeline de Análisis Estadístico Riguroso](#5-pipeline-de-análisis-estadístico-riguroso)
    - [5.1 Métricas Base](#51-métricas-base)
      - [PAR-2 (Penalized Average Runtime ×2)](#par-2-penalized-average-runtime-2)
      - [Virtual Best Solver (VBS)](#virtual-best-solver-vbs)
      - [Solve Matrix](#solve-matrix)
    - [5.2 Tests de Normalidad](#52-tests-de-normalidad)
    - [5.3 Tests Estadísticos](#53-tests-estadísticos)
      - [Para 2 Solvers](#para-2-solvers)
      - [Para k ≥ 3 Solvers](#para-k--3-solvers)
    ...
    - [5.5 Tamaños de Efecto](#55-tamaños-de-efecto)
      - [Cohen's d](#cohens-d)
      - [Vargha-Delaney A](#vargha-delaney-a)
  ...
  - [6. Motor de Ejecución de Experimentos](#6-motor-de-ejecución-de-experimentos)
    - [6.1 Pipeline de Ejecución](#61-pipeline-de-ejecución)
    - [6.2 Extracción de Métricas CDCL](#62-extracción-de-métricas-cdcl)
    - [6.3 Determinación del Resultado](#63-determinación-del-resultado)
  - [7. SAT Modeler: Lenguaje y Compilador](#7-sat-modeler-lenguaje-y-compilador)
    - [7.1 Arquitectura del Compilador](#71-arquitectura-del-compilador)
    - [7.2 Gramática del Lenguaje](#72-gramática-del-lenguaje)
    - [7.3 Compilación Tseitin](#73-compilación-tseitin)
    - [7.4 Encoding de Cardinalidad](#74-encoding-de-cardinalidad)
  - [8. Base de Datos y Modelo de Datos](#8-base-de-datos-y-modelo-de-datos)
    - [8.1 Esquema E-R](#81-esquema-e-r)
    - [8.2 Índices Optimizados](#82-índices-optimizados)
  - [9. API REST: Catálogo Completo de Endpoints](#9-api-rest-catálogo-completo-de-endpoints)
    - [9.1 Resumen](#91-resumen)
    - [9.2 Endpoints Destacados](#92-endpoints-destacados)
      - [Pipeline Riguroso Completo](#pipeline-riguroso-completo)
      - [Reporte HTML Standalone](#reporte-html-standalone)
      - [WebSocket de Progreso](#websocket-de-progreso)
      - [Solve SAT Model](#solve-sat-model)
  - [10. Stack Tecnológico Detallado](#10-stack-tecnológico-detallado)
    - [10.1 Backend — Dependencias Python](#101-backend--dependencias-python)
    - [10.2 Frontend — Dependencias npm](#102-frontend--dependencias-npm)
    - [10.3 Infraestructura Docker](#103-infraestructura-docker)
  - [11. Despliegue y Configuración](#11-despliegue-y-configuración)
    - [11.1 Prerrequisitos](#111-prerrequisitos)
    - [11.2 Comandos de Despliegue](#112-comandos-de-despliegue)
    - [11.3 URLs de Acceso](#113-urls-de-acceso)
  - [12. Conclusiones y Trabajo Futuro](#12-conclusiones-y-trabajo-futuro)
    - [12.1 Logros](#121-logros)
    - [12.2 Trabajo Futuro](#122-trabajo-futuro)
